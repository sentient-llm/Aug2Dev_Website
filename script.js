...
document.addEventListener('DOMContentLoaded', () => {
  const animateElements = document.querySelectorAll(
    '.service-card, .about-tile, .work-card, .testimonial-card, .section-tag, .section-title, .section-subtitle, .hero-content, .hero-visual, .about-content, .about-visual, .contact-info, .contact-form'
  );
